...
stateArtModel(20, 1/(2*44100), params=[30, 400, 20], alg = 'rk4Neutral', interpOrder = 2)
stateArtModel(20, 1/(4*44100), params=[30, 400, 20], alg = 'rk4Neutral', interpOrder = 2)
stateArtModel(20, 1/(8*44100), params=[30, 400, 20], alg = 'rk4Neutral', interpOrder = 2)    
stateArtModel(20, 1/(16*44100), params=[30, 400, 20], alg = 'rk4Neutral', interpOrder = 2)
stateArtModel(20, 1/(32*44100), params=[30, 400, 20], alg = 'rk4Neutral', interpOrder = 2)
