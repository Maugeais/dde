...
def stateArtModel(TMax, h, params, alg = 'rk4Neutral', tref = [], pref = []) :    
    ...
    if (len(tref) > 0) :
        ...
        plt.figure("Wave")
        plt.plot(t/omega1, np.abs(p-np.interp(t, tref, pref)), label=label)
        plt.legend()
...
t, p = stateArtModel(10, 1/(16*44100), params=[30, 500, 10], alg = 'rk4Neutral') 

stateArtModel(10, 1/(1*44100), params=[30, 500, 10], alg = 'rk4Neutral', tref = t, p)
stateArtModel(10, 1/(2*44100), params=[30, 500, 10], alg = 'rk4Neutral', t, p) 
stateArtModel(10, 1/(8*44100), params=[30, 500, 10], alg = 'rk4Neutral', t, p) 
